...
let assignmentsList = [
    { title: 'Assignment-01 [First HTML]', demo: './AhmedSherif C43 Assignment 1 [First HTML]/index.html', img: './Assignment-01 [First HTML]/output.png', codeURL },
    { title: 'Assignment-02 [User Form]', demo: '././AhmedSherif C43 Assignment 2 [UserForm]/index.html', img: './Assignment-02 [User Form]/output.png' },
    { title: 'Assignment-03 [Bakery Template]', demo: './AhmedSherif C43 Assignment 3 [Bakery Template]/index.html', img: './Assignment-03 [Bakery Template]/output.png', codeURL },
    { title: 'Assignment-04 [Fokir Template]', demo: './AhmedSherif C43 Assignment 4 [Fokir]/index.html', img: './Assignment-04 [Fokir Template]/output.png' },
    { title: 'Assignment-05 [Mealify Template]', demo: './AhmedSherif C43 Assignment 5 [Mealify]/index.html', img: './Assignment-05 [Mealify Template]/output.png', codeURL },
    { title: 'Assignment-06 [DevFolio Template]', demo: './AhmedSherif C43 Assignment 6 [DevFolio]/index.html', img: './Assignment-06 [DevFolio Template]/output.png', codeURL },
    { title: 'Assignment-07 [First JS]', demo: './AhmedSherif C43 Assignment 7 [First JS]/index.html', img: './Assignment-07 [First JS]/js-1.png', codeURL },
    { title: 'Assignment-08 [Random Quote JS & JSON]', demo: './AhmedSherif C43 Assignment 8 [Quote JS&JSON]/index.html', img: './Assignment-08 [Random Quote JS & JSON]/output.png', codeURL },
    { title: 'Assignment-09 [Bookmarker JS & LocalStorage]', demo: './AhmedSherif C43 Assignment 9 [BookMarker JS&LocalStorage]/index.html', img: './Assignment-09 [Bookmarker JS & LocalStorage]/output.png', codeURL },
    { title: 'Assignment-10 [Login JS & LocalStorage]', demo: './AhmedSherif C43 Assignment 10 [Login JS & LocalStorage]/index.html', img: './Assignment-10 [Login JS & LocalStorage]/output.png', codeURL },
    { title: 'Assignment-11 [Weather App JS]', demo: './AhmedSherif C43 Assignment 11 [Weather App JS]/index.html', img: './Assignment-11 [Weather App JS]/output.png', codeURL },
    { title: 'Assignment-12 [Party Event jQuery]', demo: './AhmedSherif C43 Assignment 12 [Party Event jQuery]/index.html', img: './Assignment-12 [Party Event jQuery]/output.png', codeURL },
